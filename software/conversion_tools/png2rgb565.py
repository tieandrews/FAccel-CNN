...
def main():
    ...
    if (len_argument != 4):
      print ("")
      print ("Correct Usage:")
      print ("\tpython png2rgb565.py <png_file> <header_file>.h <binary_file>.bin")
      print ("")
      sys.exit(0)
    ...
    try:
        ...
        print ("/* Scaled to Image Width:%d Height:%d */" % (im.size[0], im.size[1]))
    except:
    ...
    print ("const static uint16_t image64by64[] = {", file=outfile)
