...
add_fileset_file convolution_csr.sv SYSTEM_VERILOG PATH convolution_csr.sv
add_fileset_file pad_video.sv SYSTEM_VERILOG PATH pad_video.sv
...
# 
# connection point read_master_1
# 
add_interface read_master_1 avalon start
set_interface_property read_master_1 addressUnits SYMBOLS
set_interface_property read_master_1 associatedClock clock
set_interface_property read_master_1 associatedReset clock_sreset
set_interface_property read_master_1 bitsPerSymbol 8
set_interface_property read_master_1 burstOnBurstBoundariesOnly false
set_interface_property read_master_1 burstcountUnits WORDS
set_interface_property read_master_1 doStreamReads false
set_interface_property read_master_1 doStreamWrites false
set_interface_property read_master_1 holdTime 0
set_interface_property read_master_1 linewrapBursts false
set_interface_property read_master_1 maximumPendingReadTransactions 0
set_interface_property read_master_1 maximumPendingWriteTransactions 0
set_interface_property read_master_1 readLatency 0
set_interface_property read_master_1 readWaitTime 1
set_interface_property read_master_1 setupTime 0
set_interface_property read_master_1 timingUnits Cycles
set_interface_property read_master_1 writeWaitTime 0
set_interface_property read_master_1 ENABLED true
set_interface_property read_master_1 EXPORT_OF ""
set_interface_property read_master_1 PORT_NAME_MAP ""
set_interface_property read_master_1 CMSIS_SVD_VARIABLES ""
set_interface_property read_master_1 SVD_ADDRESS_GROUP ""

add_interface_port read_master_1 rm1_address address Output 32
add_interface_port read_master_1 rm1_readdata readdata Input WIDTH
add_interface_port read_master_1 rm1_byteenable byteenable Output WIDTHBE
add_interface_port read_master_1 rm1_burstcount burstcount Output WIDTHB
add_interface_port read_master_1 rm1_read read Output 1
add_interface_port read_master_1 rm1_readdatavalid readdatavalid Input 1
add_interface_port read_master_1 rm1_waitrequest waitrequest Input 1


# 
# connection point read_master_2
# 
add_interface read_master_2 avalon start
set_interface_property read_master_2 addressUnits SYMBOLS
set_interface_property read_master_2 associatedClock clock
set_interface_property read_master_2 associatedReset clock_sreset
set_interface_property read_master_2 bitsPerSymbol 8
set_interface_property read_master_2 burstOnBurstBoundariesOnly false
set_interface_property read_master_2 burstcountUnits WORDS
set_interface_property read_master_2 doStreamReads false
set_interface_property read_master_2 doStreamWrites false
set_interface_property read_master_2 holdTime 0
set_interface_property read_master_2 linewrapBursts false
set_interface_property read_master_2 maximumPendingReadTransactions 0
set_interface_property read_master_2 maximumPendingWriteTransactions 0
set_interface_property read_master_2 readLatency 0
set_interface_property read_master_2 readWaitTime 1
set_interface_property read_master_2 setupTime 0
set_interface_property read_master_2 timingUnits Cycles
set_interface_property read_master_2 writeWaitTime 0
set_interface_property read_master_2 ENABLED true
set_interface_property read_master_2 EXPORT_OF ""
set_interface_property read_master_2 PORT_NAME_MAP ""
set_interface_property read_master_2 CMSIS_SVD_VARIABLES ""
set_interface_property read_master_2 SVD_ADDRESS_GROUP ""

add_interface_port read_master_2 rm2_address address Output 32
add_interface_port read_master_2 rm2_readdata readdata Input WIDTH
add_interface_port read_master_2 rm2_byteenable byteenable Output WIDTHBE
add_interface_port read_master_2 rm2_burstcount burstcount Output WIDTHB
add_interface_port read_master_2 rm2_read read Output 1
add_interface_port read_master_2 rm2_readdatavalid readdatavalid Input 1
add_interface_port read_master_2 rm2_waitrequest waitrequest Input 1


# 
# connection point read_master_3
# 
add_interface read_master_3 avalon start
set_interface_property read_master_3 addressUnits SYMBOLS
set_interface_property read_master_3 associatedClock clock
set_interface_property read_master_3 associatedReset clock_sreset
set_interface_property read_master_3 bitsPerSymbol 8
set_interface_property read_master_3 burstOnBurstBoundariesOnly false
set_interface_property read_master_3 burstcountUnits WORDS
set_interface_property read_master_3 doStreamReads false
set_interface_property read_master_3 doStreamWrites false
set_interface_property read_master_3 holdTime 0
set_interface_property read_master_3 linewrapBursts false
set_interface_property read_master_3 maximumPendingReadTransactions 0
set_interface_property read_master_3 maximumPendingWriteTransactions 0
set_interface_property read_master_3 readLatency 0
set_interface_property read_master_3 readWaitTime 1
set_interface_property read_master_3 setupTime 0
set_interface_property read_master_3 timingUnits Cycles
set_interface_property read_master_3 writeWaitTime 0
set_interface_property read_master_3 ENABLED true
set_interface_property read_master_3 EXPORT_OF ""
set_interface_property read_master_3 PORT_NAME_MAP ""
set_interface_property read_master_3 CMSIS_SVD_VARIABLES ""
set_interface_property read_master_3 SVD_ADDRESS_GROUP ""

add_interface_port read_master_3 rm3_address address Output 32
add_interface_port read_master_3 rm3_readdata readdata Input WIDTH
add_interface_port read_master_3 rm3_byteenable byteenable Output WIDTHBE
add_interface_port read_master_3 rm3_burstcount burstcount Output WIDTHB
add_interface_port read_master_3 rm3_read read Output 1
add_interface_port read_master_3 rm3_readdatavalid readdatavalid Input 1
add_interface_port read_master_3 rm3_waitrequest waitrequest Input 1
...
set_interface_property write_master_1 associatedReset clock_sreset
...
add_interface_port write_master_1 wm1_address address Output 32
add_interface_port write_master_1 wm1_writedata writedata Output WIDTH
add_interface_port write_master_1 wm1_byteenable byteenable Output WIDTHBE
add_interface_port write_master_1 wm1_burstcount burstcount Output WIDTHB
add_interface_port write_master_1 wm1_write write Output 1
add_interface_port write_master_1 wm1_waitrequest waitrequest Input 1
