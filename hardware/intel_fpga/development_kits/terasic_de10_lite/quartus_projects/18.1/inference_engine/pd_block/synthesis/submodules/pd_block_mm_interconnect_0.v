...
module pd_block_mm_interconnect_0 (
		...
		output wire [3:0]  convolution0_slave_address,                            //                              convolution0_slave.address
		output wire        convolution0_slave_write,                              //                                                .write
		output wire        convolution0_slave_read,                               //                                                .read
		input  wire [31:0] convolution0_slave_readdata,                           //                                                .readdata
		output wire [31:0] convolution0_slave_writedata,                          //                                                .writedata
		input  wire        convolution0_slave_waitrequest,                        //                                                .waitrequest
	...
	wire  [114:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire          cmd_mux_005_src_valid;                                                          // cmd_mux_005:src_valid -> rgb_to_tensor_slave_agent:cp_valid
	wire  [114:0] cmd_mux_005_src_data;                                                           // cmd_mux_005:src_data -> rgb_to_tensor_slave_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                          // rgb_to_tensor_slave_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                        // cmd_mux_005:src_channel -> rgb_to_tensor_slave_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                  // cmd_mux_005:src_startofpacket -> rgb_to_tensor_slave_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                    // cmd_mux_005:src_endofpacket -> rgb_to_tensor_slave_agent:cp_endofpacket
	wire   [31:0] convolution0_slave_agent_m0_readdata;                                           // convolution0_slave_translator:uav_readdata -> convolution0_slave_agent:m0_readdata
	wire          convolution0_slave_agent_m0_waitrequest;                                        // convolution0_slave_translator:uav_waitrequest -> convolution0_slave_agent:m0_waitrequest
	wire          convolution0_slave_agent_m0_debugaccess;                                        // convolution0_slave_agent:m0_debugaccess -> convolution0_slave_translator:uav_debugaccess
	wire   [31:0] convolution0_slave_agent_m0_address;                                            // convolution0_slave_agent:m0_address -> convolution0_slave_translator:uav_address
	wire    [3:0] convolution0_slave_agent_m0_byteenable;                                         // convolution0_slave_agent:m0_byteenable -> convolution0_slave_translator:uav_byteenable
	wire          convolution0_slave_agent_m0_read;                                               // convolution0_slave_agent:m0_read -> convolution0_slave_translator:uav_read
	wire          convolution0_slave_agent_m0_readdatavalid;                                      // convolution0_slave_translator:uav_readdatavalid -> convolution0_slave_agent:m0_readdatavalid
	wire          convolution0_slave_agent_m0_lock;                                               // convolution0_slave_agent:m0_lock -> convolution0_slave_translator:uav_lock
	wire   [31:0] convolution0_slave_agent_m0_writedata;                                          // convolution0_slave_agent:m0_writedata -> convolution0_slave_translator:uav_writedata
	wire          convolution0_slave_agent_m0_write;                                              // convolution0_slave_agent:m0_write -> convolution0_slave_translator:uav_write
	wire    [2:0] convolution0_slave_agent_m0_burstcount;                                         // convolution0_slave_agent:m0_burstcount -> convolution0_slave_translator:uav_burstcount
	wire          convolution0_slave_agent_rf_source_valid;                                       // convolution0_slave_agent:rf_source_valid -> convolution0_slave_agent_rsp_fifo:in_valid
	wire  [115:0] convolution0_slave_agent_rf_source_data;                                        // convolution0_slave_agent:rf_source_data -> convolution0_slave_agent_rsp_fifo:in_data
	wire          convolution0_slave_agent_rf_source_ready;                                       // convolution0_slave_agent_rsp_fifo:in_ready -> convolution0_slave_agent:rf_source_ready
	wire          convolution0_slave_agent_rf_source_startofpacket;                               // convolution0_slave_agent:rf_source_startofpacket -> convolution0_slave_agent_rsp_fifo:in_startofpacket
	wire          convolution0_slave_agent_rf_source_endofpacket;                                 // convolution0_slave_agent:rf_source_endofpacket -> convolution0_slave_agent_rsp_fifo:in_endofpacket
	wire          convolution0_slave_agent_rsp_fifo_out_valid;                                    // convolution0_slave_agent_rsp_fifo:out_valid -> convolution0_slave_agent:rf_sink_valid
	wire  [115:0] convolution0_slave_agent_rsp_fifo_out_data;                                     // convolution0_slave_agent_rsp_fifo:out_data -> convolution0_slave_agent:rf_sink_data
	wire          convolution0_slave_agent_rsp_fifo_out_ready;                                    // convolution0_slave_agent:rf_sink_ready -> convolution0_slave_agent_rsp_fifo:out_ready
	wire          convolution0_slave_agent_rsp_fifo_out_startofpacket;                            // convolution0_slave_agent_rsp_fifo:out_startofpacket -> convolution0_slave_agent:rf_sink_startofpacket
	wire          convolution0_slave_agent_rsp_fifo_out_endofpacket;                              // convolution0_slave_agent_rsp_fifo:out_endofpacket -> convolution0_slave_agent:rf_sink_endofpacket
	wire          convolution0_slave_agent_rdata_fifo_src_valid;                                  // convolution0_slave_agent:rdata_fifo_src_valid -> convolution0_slave_agent_rdata_fifo:in_valid
	wire   [33:0] convolution0_slave_agent_rdata_fifo_src_data;                                   // convolution0_slave_agent:rdata_fifo_src_data -> convolution0_slave_agent_rdata_fifo:in_data
	wire          convolution0_slave_agent_rdata_fifo_src_ready;                                  // convolution0_slave_agent_rdata_fifo:in_ready -> convolution0_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_006_src_valid;                                                          // cmd_mux_006:src_valid -> convolution0_slave_agent:cp_valid
	wire  [114:0] cmd_mux_006_src_data;                                                           // cmd_mux_006:src_data -> convolution0_slave_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                          // convolution0_slave_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                        // cmd_mux_006:src_channel -> convolution0_slave_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                  // cmd_mux_006:src_startofpacket -> convolution0_slave_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                    // cmd_mux_006:src_endofpacket -> convolution0_slave_agent:cp_endofpacket
	...
	wire          rgb_to_tensor_slave_agent_rp_valid;                                             // rgb_to_tensor_slave_agent:rp_valid -> router_009:sink_valid
	wire  [114:0] rgb_to_tensor_slave_agent_rp_data;                                              // rgb_to_tensor_slave_agent:rp_data -> router_009:sink_data
	wire          rgb_to_tensor_slave_agent_rp_ready;                                             // router_009:sink_ready -> rgb_to_tensor_slave_agent:rp_ready
	wire          rgb_to_tensor_slave_agent_rp_startofpacket;                                     // rgb_to_tensor_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          rgb_to_tensor_slave_agent_rp_endofpacket;                                       // rgb_to_tensor_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          convolution0_slave_agent_rp_valid;                                              // convolution0_slave_agent:rp_valid -> router_010:sink_valid
	wire  [114:0] convolution0_slave_agent_rp_data;                                               // convolution0_slave_agent:rp_data -> router_010:sink_data
	wire          convolution0_slave_agent_rp_ready;                                              // router_010:sink_ready -> convolution0_slave_agent:rp_ready
	wire          convolution0_slave_agent_rp_startofpacket;                                      // convolution0_slave_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          convolution0_slave_agent_rp_endofpacket;                                        // convolution0_slave_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          rgb_to_tensor_slave_agent_rdata_fifo_out_valid;                                 // rgb_to_tensor_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] rgb_to_tensor_slave_agent_rdata_fifo_out_data;                                  // rgb_to_tensor_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          rgb_to_tensor_slave_agent_rdata_fifo_out_ready;                                 // avalon_st_adapter_005:in_0_ready -> rgb_to_tensor_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                              // avalon_st_adapter_005:out_0_valid -> rgb_to_tensor_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                               // avalon_st_adapter_005:out_0_data -> rgb_to_tensor_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                              // rgb_to_tensor_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                              // avalon_st_adapter_005:out_0_error -> rgb_to_tensor_slave_agent:rdata_fifo_sink_error
	wire          convolution0_slave_agent_rdata_fifo_out_valid;                                  // convolution0_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] convolution0_slave_agent_rdata_fifo_out_data;                                   // convolution0_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          convolution0_slave_agent_rdata_fifo_out_ready;                                  // avalon_st_adapter_006:in_0_ready -> convolution0_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                              // avalon_st_adapter_006:out_0_valid -> convolution0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                               // avalon_st_adapter_006:out_0_data -> convolution0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                              // convolution0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                              // avalon_st_adapter_006:out_0_error -> convolution0_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) convolution0_slave_translator (
		.clk                    (clock_clk_clk),                             //                      clk.clk
		.reset                  (nios2e_reset_reset_bridge_in_reset_reset),  //                    reset.reset
		.uav_address            (convolution0_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (convolution0_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (convolution0_slave_agent_m0_read),          //                         .read
		.uav_write              (convolution0_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (convolution0_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (convolution0_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (convolution0_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (convolution0_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (convolution0_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (convolution0_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (convolution0_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (convolution0_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (convolution0_slave_write),                  //                         .write
		.av_read                (convolution0_slave_read),                   //                         .read
		.av_readdata            (convolution0_slave_readdata),               //                         .readdata
		.av_writedata           (convolution0_slave_writedata),              //                         .writedata
		.av_waitrequest         (convolution0_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                          //              (terminated)
		.av_beginbursttransfer  (),                                          //              (terminated)
		.av_burstcount          (),                                          //              (terminated)
		.av_byteenable          (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) convolution0_slave_agent (
		.clk                     (clock_clk_clk),                                       //             clk.clk
		.reset                   (nios2e_reset_reset_bridge_in_reset_reset),            //       clk_reset.reset
		.m0_address              (convolution0_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (convolution0_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (convolution0_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (convolution0_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (convolution0_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (convolution0_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (convolution0_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (convolution0_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (convolution0_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (convolution0_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (convolution0_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (convolution0_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (convolution0_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (convolution0_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (convolution0_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (convolution0_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (convolution0_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (convolution0_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (convolution0_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (convolution0_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (convolution0_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (convolution0_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (convolution0_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (convolution0_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (convolution0_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (convolution0_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (convolution0_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (convolution0_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (convolution0_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) convolution0_slave_agent_rsp_fifo (
		.clk               (clock_clk_clk),                                       //       clk.clk
		.reset             (nios2e_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_data           (convolution0_slave_agent_rf_source_data),             //        in.data
		.in_valid          (convolution0_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (convolution0_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (convolution0_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (convolution0_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (convolution0_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (convolution0_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (convolution0_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (convolution0_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (convolution0_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) convolution0_slave_agent_rdata_fifo (
		.clk               (clock_clk_clk),                                 //       clk.clk
		.reset             (nios2e_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (convolution0_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (convolution0_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (convolution0_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (convolution0_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (convolution0_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (convolution0_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	pd_block_mm_interconnect_0_router_007 router_010 (
		.sink_ready         (convolution0_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (convolution0_slave_agent_rp_valid),         //          .valid
		.sink_data          (convolution0_slave_agent_rp_data),          //          .data
		.sink_startofpacket (convolution0_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (convolution0_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clock_clk_clk),                             //       clk.clk
		.reset              (nios2e_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	pd_block_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clock_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (nios2e_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
		.in_0_data      (convolution0_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (convolution0_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (convolution0_slave_agent_rdata_fifo_out_ready), //         .ready
