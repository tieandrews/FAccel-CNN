...
module qsys_block_mm_interconnect_0 (
	...
	wire   [25:0] nios2e_data_master_translator_avalon_universal_master_0_address;              // nios2e_data_master_translator:uav_address -> nios2e_data_master_agent:av_address
	...
	wire  [101:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> nios2e_data_master_agent:rp_data
	...
	wire   [25:0] nios2e_instruction_master_translator_avalon_universal_master_0_address;       // nios2e_instruction_master_translator:uav_address -> nios2e_instruction_master_agent:av_address
	...
	wire  [101:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> nios2e_instruction_master_agent:rp_data
	...
	wire   [25:0] nios2e_debug_mem_slave_agent_m0_address;                                      // nios2e_debug_mem_slave_agent:m0_address -> nios2e_debug_mem_slave_translator:uav_address
	...
	wire  [102:0] nios2e_debug_mem_slave_agent_rf_source_data;                                  // nios2e_debug_mem_slave_agent:rf_source_data -> nios2e_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] nios2e_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2e_debug_mem_slave_agent_rsp_fifo:out_data -> nios2e_debug_mem_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                         // cmd_mux_001:src_data -> nios2e_debug_mem_slave_agent:cp_data
	...
	wire  [101:0] cmd_mux_002_src_data;                                                         // cmd_mux_002:src_data -> onchip_ram_s1_agent:cp_data
	...
	wire  [101:0] cmd_mux_003_src_data;                                                         // cmd_mux_003:src_data -> led_s1_agent:cp_data
	...
	wire  [101:0] nios2e_data_master_agent_cp_data;                                             // nios2e_data_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] nios2e_instruction_master_agent_cp_data;                                      // nios2e_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] nios2e_debug_mem_slave_agent_rp_data;                                         // nios2e_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [101:0] onchip_ram_s1_agent_rp_data;                                                  // onchip_ram_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] led_s1_agent_rp_data;                                                         // led_s1_agent:rp_data -> router_005:sink_data
	...
	qsys_block_mm_interconnect_0_router_003 router_003 (
	...
	qsys_block_mm_interconnect_0_router_003 router_004 (
	...
	qsys_block_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clock_clk_clk),                            //       clk.clk
		.reset               (nios2e_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_block_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clock_clk_clk),                                //       clk.clk
		.reset              (nios2e_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
